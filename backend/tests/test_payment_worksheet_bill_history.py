...
def test_bill_history_stats_month_range():
    start, end = bill_history_stats_month_range(date(2026, 7, 3))
    assert start == "2025-08"
    assert end == "2026-07"


def test_bill_history_stats_month_range_year_rollover():
    start, end = bill_history_stats_month_range(date(2026, 2, 15))
    assert start == "2025-03"
    assert end == "2026-02"


def test_stats_drops_oldest_includes_current_month():
    rows = [
