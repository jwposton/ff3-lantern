...
- **Insecure badge** — sidebar warning when auth is disabled links to About authentication instructions; nav items hidden at permission `none`; sidebar footer shows display name and Log out when secured (#99, #136)
