...
- **Intermittent bill forecast** — likely and possible estimates populate worksheet Due with sky emphasis and a rich tooltip; muted intermittent rows stay muted; forecast never auto-sets planned; bill detail echoes a read-only current-month forecast (#95)
