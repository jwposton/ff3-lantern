...
- **Insecure auth badge and sidebar RBAC** — persistent "Auth disabled" banner when auth is off links to About authentication instructions; nav items hidden at permission `none`; sidebar footer shows display name and Log out when secured (#99, #136)
