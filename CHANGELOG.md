...
- **Insecure auth badge and sidebar RBAC** — persistent "Auth disabled" banner when auth is off; nav items hidden at permission `none`; sidebar footer shows display name and Log out when secured (#99, #136)
